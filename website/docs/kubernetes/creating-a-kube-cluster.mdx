...
tags: [creating-kubernetes-cluster, extensions]
---
...
| Lima      |                                             [Install the Lima extension](/docs/extensions/install) > [Install the Lima CLI](/docs/lima/installing) > [Create a Lima instance for Kubernetes](/docs/lima/creating-a-kubernetes-instance)                                             |
