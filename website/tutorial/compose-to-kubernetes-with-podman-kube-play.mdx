...
<ThemedImage
  ...
  sources={{
    light: require('./img/from-compose-to-kubernetes-with-podman-kube-play/step-3-containers-kube-play-light.png')
      .default,
    dark: require('./img/from-compose-to-kubernetes-with-podman-kube-play/step-3-containers-kube-play-dark.png')
      .default,
  }}
/>
