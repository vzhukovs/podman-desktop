"use strict";
(self["webpackChunkdocs"] = self["webpackChunkdocs"] || []).push([[78349],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_kubernetes_viewing_and_selecting_current_kubernetes_context_md_539_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-kubernetes-viewing-and-selecting-current-kubernetes-context-md-539.json
const site_docs_kubernetes_viewing_and_selecting_current_kubernetes_context_md_539_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"kubernetes/viewing-and-selecting-current-kubernetes-context","title":"Selecting a context","description":"Viewing and selecting the current Kubernetes context","source":"@site/docs/kubernetes/viewing-and-selecting-current-kubernetes-context.md","sourceDirName":"kubernetes","slug":"/kubernetes/viewing-and-selecting-current-kubernetes-context","permalink":"/docs/kubernetes/viewing-and-selecting-current-kubernetes-context","draft":false,"unlisted":false,"editUrl":"https://github.com/podman-desktop/podman-desktop/tree/main/website/docs/kubernetes/viewing-and-selecting-current-kubernetes-context.md","tags":[{"inline":true,"label":"selecting-context","permalink":"/docs/tags/selecting-context"},{"inline":true,"label":"kubernetes","permalink":"/docs/tags/kubernetes"}],"version":"current","sidebarPosition":2,"frontMatter":{"sidebar_position":2,"title":"Selecting a context","description":"Viewing and selecting the current Kubernetes context","keywords":["podman desktop","podman","containers","pods","context","kubernetes"],"tags":["selecting-context","kubernetes"]},"sidebar":"mySidebar","previous":{"title":"Existing Kubernetes","permalink":"/docs/kubernetes/existing-kubernetes/"},"next":{"title":"Managing a context","permalink":"/docs/kubernetes/managing-a-kube-context"}}');
...
;// ./docs/kubernetes/viewing-and-selecting-current-kubernetes-context.md
...
const contentTitle = 'Viewing and selecting the current Kubernetes context';
...
const toc = [{
  ...
  "value": "Procedure: Using the status bar",
  "id": "procedure-using-the-status-bar",
  "level": 4
}, {
  "value": "Procedure: Using the Podman Desktop Settings",
  "id": "procedure-using-the-podman-desktop-settings",
  "level": 4
}, {
  "value": "Procedure: Using the tray menu",
  "id": "procedure-using-the-tray-menu",
  "level": 4
}];
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      children: (0,jsx_runtime.jsx)(_components.h1, {
        id: "viewing-and-selecting-the-current-kubernetes-context",
        children: "Viewing and selecting the current Kubernetes context"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "With Podman Desktop, you can view and select your current Kubernetes context to access:"
    }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
      children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "The Kubernetes cluster you want to interact with"
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "The namespace where you define your application resources"
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Based on your configurations, Podman Desktop automatically populates the context list. For example, if you have created a Minikube, Kind, or Developer Sandbox cluster, a respective Kubernetes context is automatically added in the Podman Desktop application. Then, you can easily switch from one context to another if needed."
    }), "\n", (0,jsx_runtime.jsx)(_components.admonition, {
      type: "note",
      children: (0,jsx_runtime.jsx)(_components.p, {
        children: "When you select a Kubernetes context, you can access all the namespaces associated with it. You can switch from one namespace to another using the Kubernetes dashboard page or the Kubernetes object page."
      })
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["You have a Kubernetes context in your kubeconfig file: ", (0,jsx_runtime.jsx)(_components.em, {
      ...
      id: "procedure-using-the-status-bar",
      children: "Procedure: Using the status bar"
    }), "\n", (0,jsx_runtime.jsxs)(_components.ol, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["To view your current Kubernetes context, in the ", (0,jsx_runtime.jsx)(_components.strong, {
            children: "Podman Desktop"
          }), " main window status bar, see the name next to the ", (0,jsx_runtime.jsx)(_components.strong, {
            children: "Current Kubernetes context"
          }), " icon."]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "Optional: To change your Kubernetes context:"
        }), "\n", (0,jsx_runtime.jsxs)(_components.ol, {
          children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
            children: "Click the context in the status bar."
          }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["Select a Kubernetes context to activate from the dropdown list.\n", (0,jsx_runtime.jsx)(_components.img, {
              alt: "selecting a context from dropdown",
              src: (__webpack_require__(88572)/* ["default"] */ .A) + "",
              width: "503",
              height: "84"
            })]
          }), "\n"]
      ...
      id: "procedure-using-the-podman-desktop-settings",
      children: "Procedure: Using the Podman Desktop Settings"
    }), "\n", (0,jsx_runtime.jsxs)(_components.ol, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["Go to ", (0,jsx_runtime.jsx)(_components.strong, {
          children: "Settings > Kubernetes"
        }), " to view the configured Kubernetes contexts."]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["Optional: Click the ", (0,jsx_runtime.jsx)(_components.strong, {
          children: "Set as Current Context"
        }), " icon to change your context.\n", (0,jsx_runtime.jsx)(_components.img, {
          alt: "selecting a context",
          src: (__webpack_require__(67925)/* ["default"] */ .A) + "",
          width: "1446",
          height: "404"
        })]
      }), "\n"]
      ...
      id: "procedure-using-the-tray-menu",
      children: "Procedure: Using the tray menu"
    }), "\n", (0,jsx_runtime.jsxs)(_components.ol, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["Open the ", (0,jsx_runtime.jsx)(_components.strong, {
            children: "Podman Desktop tray"
          }), " menu."]
          ...
          children: [(0,jsx_runtime.jsxs)(TabItem/* default */.A, {
            ...
            children: [(0,jsx_runtime.jsxs)(_components.p, {
              children: ["In the task bar, click ", (0,jsx_runtime.jsx)(_components.strong, {
                children: "Show hidden icons"
              }), "."]
            }), (0,jsx_runtime.jsx)(_components.p, {
              children: (0,jsx_runtime.jsx)(_components.img, {
                alt: "Podman Desktop tray",
                src: (__webpack_require__(27453)/* ["default"] */ .A) + "",
                width: "134",
                height: "175"
              })
            }), (0,jsx_runtime.jsxs)(_components.p, {
              children: ["Right-click the ", (0,jsx_runtime.jsx)(_components.strong, {
                children: "Podman Desktop tray"
              }), " icon to open the menu."]
            }), (0,jsx_runtime.jsx)(_components.p, {
              children: (0,jsx_runtime.jsx)(_components.img, {
                alt: "Podman Desktop tray",
                src: (__webpack_require__(37213)/* ["default"] */ .A) + "",
                width: "259",
                height: "223"
              })
            })]
            ...
            children: (0,jsx_runtime.jsx)(_components.p, {
              children: (0,jsx_runtime.jsx)(_components.img, {
                alt: "Podman Desktop tray",
                src: (__webpack_require__(1599)/* ["default"] */ .A) + "",
                width: "197",
                height: "163"
              })
            })
            ...
            children: (0,jsx_runtime.jsx)(_components.p, {
              children: (0,jsx_runtime.jsx)(_components.img, {
                alt: "Podman Desktop tray",
                src: (__webpack_require__(51758)/* ["default"] */ .A) + "",
                width: "260",
                height: "222"
              })
            })
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["Click ", (0,jsx_runtime.jsx)(_components.strong, {
            children: "Kubernetes"
          }), " to see your current Kubernetes context."]
        }), "\n", (0,jsx_runtime.jsxs)(Tabs/* default */.A, {
          groupId: "operating-systems",
          children: [(0,jsx_runtime.jsx)(TabItem/* default */.A, {
            ...
            children: (0,jsx_runtime.jsx)(_components.p, {
              children: (0,jsx_runtime.jsx)(_components.img, {
                alt: "Podman Desktop tray",
                src: (__webpack_require__(84994)/* ["default"] */ .A) + "",
                width: "466",
                height: "230"
              })
            })
            ...
            children: (0,jsx_runtime.jsx)(_components.p, {
              children: (0,jsx_runtime.jsx)(_components.img, {
                alt: "Podman Desktop tray",
                src: (__webpack_require__(20738)/* ["default"] */ .A) + "",
                width: "339",
                height: "203"
              })
            })
            ...
            children: (0,jsx_runtime.jsx)(_components.p, {
              children: (0,jsx_runtime.jsx)(_components.img, {
                alt: "Podman Desktop tray",
                src: (__webpack_require__(14607)/* ["default"] */ .A) + "",
                width: "260",
                height: "303"
              })
            })
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "(Optionally) To change your Kubernetes context, click on the context name to activate."
        }), "\n"]
      }), "\n"]
    })]
  });
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("data:image/png;base64,");
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "assets/images/selecting-context-98070ce1c07467a3c2fcc44b0ac9ff95.png");
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "assets/images/tray-kubernetes-on-linux-b98e6168be359199dcee418b7e6440d6.png");
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "assets/images/tray-kubernetes-on-macos-fb22e59271337e0494700d682abe3c84.png");
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "assets/images/tray-kubernetes-on-windows-10-7977d14cab4df01d51a805539c09379b.png");
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "assets/images/tray-main-menu-on-macos-95da7e8a22faf7845c04417669304736.png");
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "assets/images/tray-main-menu-on-windows-10-6b4d40b5cadf246871f03b00689d4cb1.png");
