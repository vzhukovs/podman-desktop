...
<svg width={size} height={size} class={className} style={styleName} viewBox="-0.5 -0.5 16 16" version="1.1">
  <path
    ...
    style="fill: none; stroke-width: 1; stroke: currentColor; stroke-opacity: 1;"></path>
</svg>
